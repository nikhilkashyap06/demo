...
export default function LabEquipmentList({ 
  equipment, 
  loading, 
  onEdit, 
  onDelete 
  ...
  if (equipment.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">No lab equipment</h3>
        <p className="mt-1 text-sm text-gray-500">Get started by adding new laboratory equipment.</p>
      </div>
    );
  }
            ...
            <div className="px-4 py-4 sm:px-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-600 truncate">{item.name}</p>
                    <p className="text-sm text-gray-500 truncate">{item.category || 'No category'}</p>
                  </div>
                </div>
                <div className="flex items-center">
                  {item.is_active ? (
