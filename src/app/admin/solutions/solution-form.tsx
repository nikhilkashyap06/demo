...
export default function SolutionForm({ 
  ...
  useEffect(() => {
    if (solution) {
      setFormData({
        ...
        category: solution.category || "", // Add category field
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        alert(solution ? 'Solution updated successfully' : 'Solution created successfully');
        onSuccess();
      } else {
        setError(data.message || 'Failed to save solution');
      }
    } catch (err) {
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-1">
                ...
                >
                  ...
                  <option value="utility-scale-energy-storage">Utility Scale Energy Storage</option>
                  <option value="residential-all-in-one">Residential All-in-One</option>
